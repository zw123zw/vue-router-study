...
const router = new VueRouter({
  ...
  base: __dirname,
  routes: [
    // pathToRegexpOptions.strict 为false非严格模式，则将尾部的斜线去除
    //  pathToRegexpOptions.caseSensitive 匹配规则是否大小写敏感？(默认值：false)
    {
      path: '/',
      component: Home,
      pathToRegexpOptions: { strict: false, caseSensitive: false },
      alias: '/test'
    },
